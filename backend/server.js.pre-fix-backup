    ...
    const products = await Product.findAndCountAll({
      ...
      include: [
        { 
          model: Brand, 
          as: 'Brand',
          attributes: ['id', 'name', 'ontology_uri'] 
        }
      ],
      ...
      attributes: [
        ...
        'description', 'ontology_uri', 'alcohol_free', 'fragrance_free', 
    ...
    const product = await Product.findOne({
      ...
      include: [
        ...
        },
        {
          ...
          as: 'Ingredients',
          attributes: [
            'id', 'name', 'ontology_uri', 'what_it_does', 'explanation',
